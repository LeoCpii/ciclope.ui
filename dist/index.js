...
class Lizard {
    static __initStatic() {this.themes = ['default', 'micrablepharus', 'vanzosaura', 'custom']}
    static __initStatic2() {this.modes = ['dark', 'light']}
...
} Lizard.__initStatic(); Lizard.__initStatic2();
